...
class InsertUserUseCase @Inject constructor(
    ...
    suspend operator fun invoke(email: String,name : String, address: String,age: Int, id: String?, img:String) {
        signUpRepository.insertUser(email,name,address,age, id, img)
    }
}